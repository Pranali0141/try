...
<body>
	<header>
		<div class="container">
			<div id ="branding">
				<h1><span class="highlight">Royal City</span> Bank.</h1>
			</div>
			<nav>
				<ul>
	...
	<section id ="showcase">
		...
		<p>Royal City Family banking is proud to all indians and we are also proud to serve the nation.</p>
		</div>
	</section>
	<section id ="options">
		<div class="container">
		...
		/*This is secure page. So, after logout the page should not go back. For that we have two ways.
			...
			response.sendRedirect("Login.jsp");
				...
				Vector ckAccounts = (Vector)session.getAttribute("ckAccounts");
			      	...
			      	//final AccountDetails ck_Acc; 
				       // 	ck_Acc = new AccountDetails(CAcc_no);
