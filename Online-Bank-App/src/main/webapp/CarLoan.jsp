...
<body>
	...
	<section id="options">
	<div class="container">
	<h1 style="float: none; color: orange;font-size: 26px">Own your favourite car with exciting offerings from Royal City Bank Car Loans </h1>
		<h1 style="float: none;">Welcome to Royal City Internet Banking..</h1>
		<h1 style="float: none; color: green;font-size: 20px">Special Offerings: </h1>
		<ul>
			<li> Tenure up to 8 years</li>
			<li> Funding on Accessory available</li>
			<li> Customised Repayment Scheme available</li>
			<li> EMI/Lakh starting Rs 1539*</li>
		</ul>
